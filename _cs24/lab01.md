...
```
	git clone git@github.com:ucsb-cmptgcs1a-f23/cs24-s18-starter-code.git
```
...
[https://github.com/ucsb-cmptgcs1a-f23/lab00_jgaucho](https://github.com/ucsb-cmptgcs1a-f23/lab00_jgaucho). Click on the green "clone or download" button. Then click on the address of your repo.
...
```
	cd ~/cs24
	git clone git@github.com:ucsb-cmptgcs1a-f23/lab00_jgaucho.git
```
