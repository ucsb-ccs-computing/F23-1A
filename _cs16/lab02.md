...
* Using the web-browser, navigate to your newly created repo on github. Find the address of your git repo. Click on the green "clone or download button". If your git repo was named lab02_jgaucho, then the git address should something like: "git@github.com:ucsb-cmptgcs1a-f23/lab02_jgaucho.git". Now clone your repo into your CSIL account by typing the following on the terminal, replacing the last argument with the address of your git repo.

```
git clone git@github.com:ucsb-cmptgcs1a-f23/lab02_jgaucho.git
```
